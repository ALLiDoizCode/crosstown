#!/usr/bin/env bash
# Fund Peer Wallet with AGENT Tokens
#
# This script transfers AGENT tokens from the deployer account (Account #0)
...
# Parse arguments
PEER_ADDRESS="${1:-}"
AMOUNT="${2:-50000}"  # Default 50,000 AGENT tokens
...
log_info "Funding peer wallet with AGENT tokens..."
echo ""
echo "  Peer Address:  $PEER_ADDRESS"
echo "  Amount:        $AMOUNT AGENT"
...
log_info "Transferring $AMOUNT AGENT tokens..."
...
log_success "Peer wallet balance: $BALANCE AGENT tokens"
echo ""
